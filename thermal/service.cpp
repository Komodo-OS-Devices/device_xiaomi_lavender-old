...
static int shutdown() {
    LOG(ERROR) << "Lavender Thermal HAL Service is shutting down.";
    return 1;
}
...
int main(int /* argc */, char ** /* argv */) {
    ...
    LOG(INFO) << "Lavender Thermal HAL Service 2.0 starting...";
    ...
    LOG(INFO) << "Lavender Thermal HAL Service 2.0 started successfully.";
    joinRpcThreadpool();
